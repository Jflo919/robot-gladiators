...
/* Refined game goals: 
 If a blank or null value is received for a player name, repeat prompt() until an acceptable answer is received.
 Extend the null input validation check to the fight-or-skip prompt as well.
 Make the response to the fight-or-skip prompt case-insensitive
 Use conditional statements that execute based on the response's numeric value in the shop() function
 Randomize the fight order at the beginning of every round with a new enemy robot.
